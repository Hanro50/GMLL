...
import za.net.hanro50.agenta.objects.HTTPException;
 ...
 class Resource extends URLConnection {
  String indexString;
  
  public Resource(URL url) {
    super(url);

    Main.prn.info("Proxying resources...");
    try {
      ...
      Main.prn.warning("An error occurred.");
      e.printStackTrace();
    } 
    Main.prn.info("Loading fallback");
